...
This [_Hello world_](https://github.com/datapane/datapane/blob/master/src/datapane/resources/app_templates/hello/hello.py) page itself was generated with Datapane!
        """
    ),
    dp.Text(
        """
...
- [Checkout the source – browse the Datapane repo](https://github.com/datapane/datapane)
"""
    ),
)
